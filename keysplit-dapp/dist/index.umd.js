(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('secrets.js-next'), require('bip39'), require('create-hash'), require('unorm'), require('crypto'), require('request-promise-native'), require('web3'), require('web3-provider-engine'), require('web3-provider-engine/subproviders/fixture.js'), require('web3-provider-engine/subproviders/filters.js'), require('ethereumjs-wallet/provider-engine'), require('web3-provider-engine/subproviders/web3.js'), require('ethereumjs-wallet'), require('bignumber.js')) :
  typeof define === 'function' && define.amd ? define(['exports', 'secrets.js-next', 'bip39', 'create-hash', 'unorm', 'crypto', 'request-promise-native', 'web3', 'web3-provider-engine', 'web3-provider-engine/subproviders/fixture.js', 'web3-provider-engine/subproviders/filters.js', 'ethereumjs-wallet/provider-engine', 'web3-provider-engine/subproviders/web3.js', 'ethereumjs-wallet', 'bignumber.js'], factory) :
  (factory((global.KeySplit = global.KeySplit || {}, global.KeySplit.js = global.KeySplit.js || {}),global.secrets,global.bip39,global.createHash,global.unorm,global.crypto,global.rp,global.Web3,global.ProviderEngine,global.FixtureSubprovider,global.FilterSubprovider,global.WalletSubprovider,global.Web3Subprovider,global.Wallet,global.BigNumber));
}(this, (function (exports,secrets,bip39,createHash,unorm,crypto,rp,Web3,ProviderEngine,FixtureSubprovider,FilterSubprovider,WalletSubprovider,Web3Subprovider,Wallet,BigNumber) { 'use strict';
